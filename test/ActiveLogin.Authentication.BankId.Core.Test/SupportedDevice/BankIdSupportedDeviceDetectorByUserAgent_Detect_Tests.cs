...
public class BankIdSupportedDeviceDetectorByUserAgent_Detect_Tests
{
    private readonly BankIdSupportedDeviceDetectorByUserAgent _bankIdSupportedDeviceDetectorByUserAgent;

    public BankIdSupportedDeviceDetectorByUserAgent_Detect_Tests()
    {
        _bankIdSupportedDeviceDetectorByUserAgent = new BankIdSupportedDeviceDetectorByUserAgent();
    }
    ...
    public void Should_Only_Detect_Ios_And_Mobile_When_Iphone_User_Agent()
    {
        ...
        var detectedDevice = _bankIdSupportedDeviceDetectorByUserAgent.Detect(userAgent);
