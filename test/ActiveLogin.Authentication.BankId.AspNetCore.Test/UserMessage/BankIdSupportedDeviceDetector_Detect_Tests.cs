...
namespace ActiveLogin.Authentication.BankId.AspNetCore.Test.UserMessage
{
    public class BankIdSupportedDeviceDetector_Detect_Tests
    {
        ...
        {
            BankIdSupportedDevice detectedDevice = _bankIdSupportedDeviceDetector.Detect(userAgent);
        ...
        {
            string userAgent = "Mozilla/5.0 (iPad; CPU OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/604.1";
            BankIdSupportedDevice detectedDevice = _bankIdSupportedDeviceDetector.Detect(userAgent);
        ...
        {
            string userAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 12_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.0 Mobile/15E148 Safari/604.1";
            BankIdSupportedDevice detectedDevice = _bankIdSupportedDeviceDetector.Detect(userAgent);
        ...
        {
            string userAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/601.7.7 (KHTML, like Gecko) Version/9.1.2 Safari/601.7.7";
            BankIdSupportedDevice detectedDevice = _bankIdSupportedDeviceDetector.Detect(userAgent);
        ...
        {
            string userAgent = "Mozilla/5.0 (Windows Phone 10.0; Android 6.0.1; Xbox; Xbox One) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Mobile Safari/537.36 Edge/16.16299";
            BankIdSupportedDevice detectedDevice = _bankIdSupportedDeviceDetector.Detect(userAgent);
