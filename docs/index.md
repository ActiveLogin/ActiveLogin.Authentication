...
- Supports BankID Auth and Sign
- Cross platform: Targets .NET Standard 2.0 and .NET 6
- Built on V5.1 (the latest) BankID JSON API
- Supports BankID QR code and Cancel
- GDPR: Security by design
- Designed with Microsoft Azure in mind (KeyVault, Monitor, Application Insights, AD B2C etc.)
- Multi language support with English and Swedish out of the box
- Customizable UI
- Can be used as a [Custom Identity Provider for Azure AD B2C](#how-do-i-use-active-login-to-get-support-for-bankid-in-azure-ad-active-directory-b2c)
