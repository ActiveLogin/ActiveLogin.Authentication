...
namespace ActiveLogin.Authentication.BankId.Api.Models
{
    ...
    public class Requirement
    {
        ...
        ///     Users of iOS and Android devices may use fingerprint for authentication and signing if the device supports it and
        ///     the user configured the device to use it.
