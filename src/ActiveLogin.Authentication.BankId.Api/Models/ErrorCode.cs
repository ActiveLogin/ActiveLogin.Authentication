namespace ActiveLogin.Authentication.BankId.Api.Models
{
    ...
    public enum ErrorCode
    {
        ...
        ///     RP must inform the user that an auth or sign order is already in progress for the user. Message RFA4 should be
        ///     used.
        /// </summary>
        AlreadyInProgress,
        ...
        ///     * Using an orderRef that is too old. completed orders can only be collected up to 3 minutes and failed orders up to
        ///     5 minutes.
