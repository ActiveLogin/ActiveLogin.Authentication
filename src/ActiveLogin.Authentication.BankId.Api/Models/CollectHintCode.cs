namespace ActiveLogin.Authentication.BankId.Api.Models
{
    ...
    public enum CollectHintCode
    {
        ...
        ///     The BankID security app/program did not start, the user did not finalize the signing or the RP called collect too
        ///     late.
        /// </summary>
        ExpiredTransaction,
        ...
        /// <summary>
        ///     The user did not provide her ID, or the RP requires AutoStartToken to be used, but the client did not start within
        ///     a certain time limit. The reason may be:
