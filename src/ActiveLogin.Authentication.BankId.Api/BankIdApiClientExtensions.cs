...
namespace ActiveLogin.Authentication.BankId.Api
{
    ...
    public static class BankIdApiClientExtensions
    {
        ...
        ///     Note the importance of using the correct IP address.It must be the IP address representing the user agent (the end
        ///     user device) as seen by the RP.
        ...
        /// </param>
        /// <returns>If the request is successful, the OrderRef and AutoStartToken is returned.</returns>
        public static Task<SignResponse> SignAsync(this IBankIdApiClient apiClient, string endUserIp,
        ...
        /// <returns>If the request is successful, the OrderRef and AutoStartToken is returned.</returns>
        public static Task<SignResponse> SignAsync(this IBankIdApiClient apiClient, string endUserIp,
            string userVisibleData, byte[] userNonVisibleData)
        {
        ...
        /// <returns>If the request is successful, the OrderRef and AutoStartToken is returned.</returns>
        public static Task<SignResponse> SignAsync(this IBankIdApiClient apiClient, string endUserIp,
            string userVisibleData, byte[] userNonVisibleData, string personalIdentityNumber)
        {
            return apiClient.SignAsync(new SignRequest(endUserIp, userVisibleData, userNonVisibleData,
