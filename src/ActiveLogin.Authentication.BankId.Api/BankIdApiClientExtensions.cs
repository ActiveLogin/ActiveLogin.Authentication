...
namespace ActiveLogin.Authentication.BankId.Api
{
    ...
    public static class BankIdApiClientExtensions
    {
        ...
        /// </param>
        /// <returns>If the request is successful, the OrderRef and AutoStartToken is returned.</returns>
        public static Task<SignResponse> SignAsync(this IBankIdApiClient apiClient, string endUserIp, string userVisibleData, string userNonVisibleData = null)
        {
        ...
        /// </param>
        /// <returns>If the request is successful, the OrderRef and AutoStartToken is returned.</returns>
        public static Task<SignResponse> SignAsync(this IBankIdApiClient apiClient, string endUserIp, string personalIdentityNumber, string userVisibleData, string userNonVisibleData = null)
        {
            return apiClient.SignAsync(new SignRequest(endUserIp, personalIdentityNumber, userVisibleData, userNonVisibleData));
        }
