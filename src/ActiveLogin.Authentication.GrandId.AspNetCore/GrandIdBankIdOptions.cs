...
{
    public class GrandIdBankIdOptions : GrandIdOptions
    {
        public override string AuthenticationMethodName { get; set; } = GrandIdDefaults.BankIdAuthenticationMethodName;
