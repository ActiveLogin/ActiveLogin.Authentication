...
namespace ActiveLogin.Authentication.GrandId.AspNetCore
{
    ...
    {
        private static IGrandIdAuthenticationBuilder UseEnvironment(this IGrandIdAuthenticationBuilder builder,
            Uri apiBaseUrl, Action<IGrandIdEnvironmentConfiguration> configuration)
        {
            ...
            if (string.IsNullOrEmpty(environmentConfiguration.ApiKey))
                throw new InvalidOperationException(
                    $"A valid '{nameof(environmentConfiguration.ApiKey)}' must be provided.'");
        ...
        /// <returns></returns>
        public static IGrandIdAuthenticationBuilder UseTestEnvironment(this IGrandIdAuthenticationBuilder builder,
            Action<IGrandIdEnvironmentConfiguration> configuration)
        {
        ...
        /// <param name="configuration">Configure GrandID.</param>
        /// <returns></returns>
        public static IGrandIdAuthenticationBuilder UseProductionEnvironment(this IGrandIdAuthenticationBuilder builder,
            Action<IGrandIdEnvironmentConfiguration> configuration)
        {
        ...
        {
            return UseSimulatedEnvironment(builder, x => new GrandIdSimulatedApiClient());
        }

        public static IGrandIdAuthenticationBuilder UseSimulatedEnvironment(this IGrandIdAuthenticationBuilder builder,
            string givenName, string surname)
        {
            return UseSimulatedEnvironment(builder, x => new GrandIdSimulatedApiClient(givenName, surname));
        }
            ...
            string givenName, string surname, string personalIdentityNumber)
        {
            return UseSimulatedEnvironment(builder,
                x => new GrandIdSimulatedApiClient(givenName, surname, personalIdentityNumber));
        }


        private static IGrandIdAuthenticationBuilder UseSimulatedEnvironment(this IGrandIdAuthenticationBuilder builder,
            Func<IServiceProvider, IGrandIdApiClient> grandIdDevelopmentApiClient)
        {
        ...
        private static IGrandIdAuthenticationBuilder AddGrandIdApiClient(this IGrandIdAuthenticationBuilder builder,
            string apiKey, string bankIdServiceKey)
        {
            builder.AuthenticationBuilder.Services.TryAddTransient(x =>
                new GrandIdApiClientConfiguration(apiKey, bankIdServiceKey));
