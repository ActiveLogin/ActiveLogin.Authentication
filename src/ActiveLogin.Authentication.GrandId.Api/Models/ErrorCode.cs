namespace ActiveLogin.Authentication.GrandId.Api.Models
{
    ...
    public enum ErrorCode
    {
        ...
        /// <summary>
        ///     The provided apiKey and AuthenticateServiceKey could not be validated: Authentication keys are wrong
        ///     (FederatedLogin).
        /// </summary>
        ApiKeyNotValid01,
        ...
        /// <summary>
        ///     Transaction expired before user authenticated: The transaction was expired by bankid before it was completed on
        ///     GrandIDs end.
        /// </summary>
        Expired_Transaction
    }
