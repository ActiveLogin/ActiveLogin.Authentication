...
namespace ActiveLogin.Authentication.BankId.AspNetCore
{
    public static class BankIdAuthenticationBuilderSchemeExtensions
    {
        internal static IBankIdAuthenticationBuilder AddScheme(this IBankIdAuthenticationBuilder builder,
            string authenticationScheme, string displayName, Action<BankIdAuthenticationOptions> configureOptions,
        ...
        /// <returns></returns>
        public static IBankIdAuthenticationBuilder Configure(this IBankIdAuthenticationBuilder builder,
        ...
        {
            return AddSameDevice(builder, BankIdAuthenticationDefaults.SameDeviceAuthenticationScheme,
                BankIdAuthenticationDefaults.SameDeviceDisplayName, options => { });
        }
        ...
        {
            return AddSameDevice(builder, BankIdAuthenticationDefaults.SameDeviceAuthenticationScheme,
                BankIdAuthenticationDefaults.SameDeviceDisplayName, configureOptions);
        }

        public static IBankIdAuthenticationBuilder AddSameDevice(this IBankIdAuthenticationBuilder builder,
            string authenticationScheme, Action<BankIdAuthenticationOptions> configureOptions)
        {
            return AddSameDevice(builder, authenticationScheme, BankIdAuthenticationDefaults.SameDeviceDisplayName,
                configureOptions);
        }
        ...
        {
            return AddOtherDevice(builder, BankIdAuthenticationDefaults.OtherDeviceAuthenticationScheme,
                BankIdAuthenticationDefaults.OtherDeviceDisplayName, options => { });
        }
        ...
        {
            return AddOtherDevice(builder, BankIdAuthenticationDefaults.OtherDeviceAuthenticationScheme,
                BankIdAuthenticationDefaults.OtherDeviceDisplayName, configureOptions);
        }

        public static IBankIdAuthenticationBuilder AddOtherDevice(this IBankIdAuthenticationBuilder builder,
            string authenticationScheme, Action<BankIdAuthenticationOptions> configureOptions)
        {
            return AddOtherDevice(builder, authenticationScheme, BankIdAuthenticationDefaults.OtherDeviceDisplayName,
                configureOptions);
        }
